...
namespace idea102Core.Application.Catalog.Products
{
    public class ManageProductService : IManageProductService
    {
        ...
        public async Task<int> Update(ProductUpdateRequest request)
        {
            ...
            if (product == null || productTranslation == null) throw new iCoreException($"Không tìm thấy sản phẩm với id: {request.Id}");
        ...
        {
            var product = await _context.Products.FindAsync(productId);
            if (product == null) throw new iCoreException($"Không tìm thấy sản phẩm với id: {productId}");
